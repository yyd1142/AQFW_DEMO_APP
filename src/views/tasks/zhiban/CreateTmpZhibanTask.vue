    ...
    <div class="CreateTmpZhibanTable">
        ...
        <div class="page-wrap">
            ...
            <div class="form-card last-child">
                ...
                <mko-form-cell title="有效期" :val="formData.validPeriod || '请选择'" v-model="formData.validPeriod"
                               :edit="true" type="sel" @click="popupPickerShow('validPeriod')"></mko-form-cell>
        ...
        <mko-popup-bottom :title="popupName" v-model="selPopupShow" @save="selPickerVal" @cancel="selPopupClose">
            <mt-picker :slots="zhibanTimes" value-key="Name" @change="onZhibanTimeChange" :visible-item-count="5"
                       :show-toolbar="false" v-show="pickerWrapperName === 'zhibanTime'"></mt-picker>
            ...
            <mt-picker :slots="validPeriods" value-key="Name" @change="onValidPeriodChange" :visible-item-count="5"
                       :show-toolbar="false" v-show="pickerWrapperName === 'validPeriod'"></mt-picker>
            <mko-select-box :column="4" :options="zhibanNames" :selected="zhibanNamesSelecteds"
                            @select="onZhibanNameChange" v-show="pickerWrapperName === 'zhibanName'"></mko-select-box>
        </mko-popup-bottom>
    </div>
</template>
        ...
        data() {
            return {
                ...
                formData: {
                    ...
                    endDate: '',
                    validPeriod: '',
                    banciDatas: [{startTime: '', endTime: '', executor: '', bcTime: '', executorName: ''}]
                },
                validPeriod: {
                    startDate: '',
                    endDate: '',
