<template>
    <div class="CreateZhibanTable">
        ...
        <mko-header title="新建值班表" left-icon="icon-back" @handleLeftClick="back" right-icon-text="保存"
                    @handleRightClick="save"></mko-header>
        <div class="page-wrap">
            <div class="form-card">
            ...
            <div class="form-card last-child">
                <mko-form-cell title="行业类型" :val="depFilter[formData.dep] || '选择'" v-model="depFilter[formData.dep]" :edit="true" type="sel"
            ...
            <mko-edit-card :title="'班次'+ (index + 1)" title-color="black-font" :edit="false" :remove="true"
                           @remove="removeZhibanCard(index)" v-for="(cell, index) in formData.banciDatas">
                <mko-form-cell title="班次名称" :edit="true" type="text" v-model="cell.bcName"
    ...
    export default {
        data() {
            return {
                ...
                zhibanNames: [],
                formData: {
                    description: '', dep: '', xiuxiri: '', zbDescribe: '', banciDatas: [{
