    ...
    <div class="StartXuncha">
        ...
        <div class="page-wrap">
            ...
            <div class="check-point-wrap" v-for="build, buildIndex  in builds">
                ...
                <div class="floor" v-for="position, positionIndex in build.positions" @click="startQianDao(build, position)">
                    <div class="padding floor-wrap">
                        <div class="floor-name">
                            <span class="item">{{position.name}}</span>
                            <span class="device-account yellow-font" v-if="position.yh_amount && position.yh_amount > 0">{{position.yh_amount}}个风险</span>
                            <span class="device-account" v-else>{{position.status | CheckPointPositionStatusFilter}}</span>
